...
@pytest.fixture
def ek80_bb_complex_multiplex_path(test_path):
    return test_path['EK80_BB_COMPLEX_MULTIPLEX']
...
def test_ek80_BB_complex_multiplex_NaNs_and_non_NaNs(raw_data_path, target_channel_ping_pattern, ek80_bb_complex_multiplex_path):
    # Extract bb complex multiplex EK80 data
    ed = ep.open_raw(ek80_bb_complex_multiplex_path.joinpath(raw_data_path), sonar_model="EK80")
